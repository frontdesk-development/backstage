...
// will be established
export const CloudBuildWidget = () => (
  <MemoryRouter initialEntries={['/cloudbuild']}>
    <AppStateProvider>
      <>
        <Routes>
          <Route path="/cloudbuild" element={<Builds />} />
          <Route
            path="/cloudbuild/build/:buildId"
            element={<BuildWithSteps />}
          />
        </Routes>
        <Settings />
      </>
